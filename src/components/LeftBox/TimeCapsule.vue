<template>
  <div class="time-capsule">
    ...
    <span class="text">Today has been spent&nbsp;{{ timeData.day.elapsed }}&nbsp;hours</span>
    <el-progress :text-inside="true" :stroke-width="20" :percentage="timeData.day.pass" />
    <span class="text">This week has been spent&nbsp;{{ timeData.week.elapsed }}&nbsp;days</span>
    <el-progress :text-inside="true" :stroke-width="20" :percentage="timeData.week.pass" />
    <span class="text">This month has been spent&nbsp;{{ timeData.month.elapsed }}&nbsp;days</span>
    <el-progress :text-inside="true" :stroke-width="20" :percentage="timeData.month.pass" />
    <span class="text">This year has been spent&nbsp;{{ timeData.year.elapsed }}&nbsp;months</span>
