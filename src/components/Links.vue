<template>
  <div v-if="siteLinks[0]" class="links">
    <div class="line">
      ...
      <span class="title">Check for details</span>
    </div>
    <!-- 网站列表 -->
    <Swiper
      v-if="siteLinks[0]"
...
import { Link, Users, NewspaperRegular, Book, Tasks, PhotoVideo, SearchLocation } from "@vicons/fa"; // 注意使用正确的类别
